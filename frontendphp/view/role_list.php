        ...
        <div class="flex-1 p-6">
            <div class="max-w-3xl mx-auto">
                ...
                <div class="flex justify-end mb-4">
                    <a href="view/role_input.php" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded">Insert New Role</a>
                </div>
                        ...
                        <tbody class="text-gray-600 text-sm">
                            <?php foreach ($Roles as $role) { ?>
                                <tr class="text-center border-t">
                                    <td class="py-2 px-3"><?php echo htmlspecialchars($role->role_id) ?></td>
                                    <td class="py-2 px-3"><?php echo htmlspecialchars($role->role_name) ?></td>
                                    <td class="py-2 px-3"><?php echo htmlspecialchars($role->role_description) ?></td>
                                    <td class="py-2 px-3"><?php echo htmlspecialchars($role->role_status ? "Active" : "Inactive") ?></td>
                                    <td class="py-2 px-3 flex justify-center">
                                        <form action="index.php?modul=role&fitur=edit&role_id=<?= $role->role_id ?>" method="POST" class="mr-2">
